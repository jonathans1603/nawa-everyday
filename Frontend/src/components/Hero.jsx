  ...
  return (
    ...
    >
      ...
      >
        {CLONED.map((slide, i) => (
          ...
          >
            ...
            {/* Teks */}
            <div className="absolute inset-0 flex items-center justify-end pr-[clamp(24px,6vw,80px)]">
      ...
      <button
        onClick={() => goPrev()}
        aria-label="Previous"
        className="absolute left-5 top-1/2 -translate-y-1/2 z-10 w-11 h-11 rounded-full bg-white/70 border-2 border-white/90 text-[#2e3a1a] shadow-md hover:bg-white/95 hover:scale-110 transition-all duration-200 flex items-center justify-center"
      ...
      <button
        onClick={() => goNext()}
        aria-label="Next"
        className="absolute right-5 top-1/2 -translate-y-1/2 z-10 w-11 h-11 rounded-full bg-white/70 border-2 border-white/90 text-[#2e3a1a] shadow-md hover:bg-white/95 hover:scale-110 transition-all duration-200 flex items-center justify-center"
        style={{ fontSize: 26, lineHeight: 1, paddingBottom: 2 }}
      >
        ›
      </button>
